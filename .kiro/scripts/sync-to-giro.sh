...
echo "  ✓ .kiro/steering/steering-examples/"
...
cp -r .kiro/steering/steering-examples "$GIRO_PATH/.kiro/steering/" 2>/dev/null || true
...
cp -r .kiro/husky "$GIRO_PATH/.kiro/" 2>/dev/null || true
cp -r .kiro/github "$GIRO_PATH/.kiro/" 2>/dev/null || true
